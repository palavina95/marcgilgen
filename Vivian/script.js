...
window.onload = function() {
        ...
        marker.addEventListener("dragend", function(e){
            ...
            longitude = this.getLatLng()["lng"];
                    ...
                    var getSwissValue = convertLatLng(latitude, longitude);
                    ...
                    document.getElementById("zoneProtection").setAttribute("src",'http://wms.geo.admin.ch/?SERVICE=WMS&REQUEST=GetMap&VERSION=1.1.0&LAYERS=ch.bafu.grundwasserschutzzonen&STYLES=default&SRS=EPSG:21781&BBOX='+temp1+','+temp2+','+temp3+','+temp4+'&WIDTH=600&HEIGHT=4000&FORMAT=image/png');
